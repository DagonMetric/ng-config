...
2. [Fork](https://help.github.com/articles/fork-a-repo/) the [repo](https://github.com/dagonmetric/ng-config) and create your branch `topic` from master.
...
8. In GitHub, submit a [pull request](https://help.github.com/articles/about-pull-requests) to [dagonmetric/ng-config](https://github.com/dagonmetric/ng-config).
